...
func (c *adminClient) TaskCreate(ctx context.Context, in *TaskCreateRequest, opts ...grpc.CallOption) (*TaskCreateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ozon.dev.tms.api.Admin/TaskCreate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminClient) TaskList(ctx context.Context, in *TaskListRequest, opts ...grpc.CallOption) (*TaskListResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ozon.dev.tms.api.Admin/TaskList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminClient) TaskUpdate(ctx context.Context, in *TaskUpdateRequest, opts ...grpc.CallOption) (*TaskUpdateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ozon.dev.tms.api.Admin/TaskUpdate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminClient) TaskDelete(ctx context.Context, in *TaskDeleteRequest, opts ...grpc.CallOption) (*TaskDeleteResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ozon.dev.tms.api.Admin/TaskDelete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminClient) TaskGet(ctx context.Context, in *TaskGetRequest, opts ...grpc.CallOption) (*TaskGetResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ozon.dev.tms.api.Admin/TaskGet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Admin_TaskCreate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ozon.dev.tms.api.Admin/TaskCreate",
	}
...
func _Admin_TaskList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ozon.dev.tms.api.Admin/TaskList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Admin_TaskUpdate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ozon.dev.tms.api.Admin/TaskUpdate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Admin_TaskDelete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ozon.dev.tms.api.Admin/TaskDelete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Admin_TaskGet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ozon.dev.tms.api.Admin/TaskGet",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Admin_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ozon.dev.tms.api.Admin",
